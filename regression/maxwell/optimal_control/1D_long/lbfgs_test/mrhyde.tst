...
desc = '''1D Maxwell optimal control (ROL2, quasi-Newton): no parameter mass matrix (default inner product / unweighted coefficient norm).'''
...
#TESTING active
#TESTING -n 8
#TESTING -k maxwell,HCURL,optimization,regression
...
status += its.call('mpiexec -n 8 ../../../../mrhyde >& mrhyde.log')
